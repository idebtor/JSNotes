...
// *space*property
var dotNotation5 = false;           // Some browsers return true //
...
**Tip**: Bracket notation always works. Dot notation requires properties that begin with a letter and do not include special characters.
